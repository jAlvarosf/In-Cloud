...
<head>
    <title>In-Cloud</title><meta charset="UTF-8" />
...
<body>
    <div id="loginbox">
        ...
        <form id="loginform" class="form-vertical" method="post" action="{{ url('admin') }}">{{ csrf_field() }}
            <div class="control-group normal_text"><h3><img src="{{asset('images/backend_images/logofive_login.png')}}"style="width:250px; height:100px; alt="Logo" /></h3></div>
